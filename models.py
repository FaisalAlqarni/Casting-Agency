...
def db_seeding():
    ...
    association1 = association.insert().values(movie_id=movie1.id, actor_id=actor1.id)    
    association2 = association.insert().values(movie_id=movie1.id, actor_id=actor2.id)    
    association3 = association.insert().values(movie_id=movie1.id, actor_id=actor3.id)    
    association4 = association.insert().values(movie_id=movie1.id, actor_id=actor4.id)    
    association5 = association.insert().values(movie_id=movie1.id, actor_id=actor5.id)    
    association6 = association.insert().values(movie_id=movie1.id, actor_id=actor6.id)  
      
    association7 = association.insert().values(movie_id=movie2.id, actor_id=actor1.id)    
    association8 = association.insert().values(movie_id=movie2.id, actor_id=actor2.id)    
    association9 = association.insert().values(movie_id=movie2.id, actor_id=actor3.id)
    
    association10 = association.insert().values(movie_id=movie3.id, actor_id=actor4.id)    
    association11 = association.insert().values(movie_id=movie3.id, actor_id=actor5.id)    
    association12 = association.insert().values(movie_id=movie3.id, actor_id=actor6.id)
